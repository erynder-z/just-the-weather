...
var forecastTimestamp = document.createElement('div'); // Event listeners

searchButton.addEventListener('click', handleSearch);
searchbar.addEventListener('keydown', handleSearchKeyDown);
forecastBtnContainer.addEventListener('click', handleForecastBtnClick); // Functions
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            currentCity = document.getElementById('currentCity').innerHTML;
            _context.next = 3;
            return (0,_modules_getWeather__WEBPACK_IMPORTED_MODULE_2__.getForecast)(currentCity);
...
function handleSearch() {
  ...
  if (forecastBtnContainer.classList.contains('expand')) {
    (0,_modules_getWeather__WEBPACK_IMPORTED_MODULE_2__.getForecast)(_modules_getWeather__WEBPACK_IMPORTED_MODULE_2__.myLocation);
  }
}
...
(0,_modules_getWeather__WEBPACK_IMPORTED_MODULE_2__.getCurrentWeather)(_modules_getWeather__WEBPACK_IMPORTED_MODULE_2__.myLocation);
...
var colorizeForecast = function colorizeForecast(weatherDataDescription) {
  var substringRain = 'rain';
  var substringSnow = 'snow';

  if (weatherDataDescription.replace(/\s/g, '-') === 'few-clouds' || weatherDataDescription.includes(substringRain) && !weatherDataDescription.includes(substringSnow)) {
    return true;
  }
};
